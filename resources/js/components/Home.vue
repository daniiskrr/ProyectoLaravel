<template>
    ...
    <div class="titulo-seccion-ps4">
        <h2>Explora PlayStation®4</h2>
        <p>Juegos increíbles, entretenimiento sin fin. Es el mejor momento para disfrutar de PS4.</p>
    </div>

    <section class="seccion-ps4">
        <div class="row">
            <div class="col">
                <div class="ps4">
